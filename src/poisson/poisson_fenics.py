...
def solve_fenics_scalar_params(
    source_param, bc_param, geo_params, disc_points=256, resolution=16
):
    c1, c2 = geo_params
...
if __name__ == "__main__":
    ...
    source_params, bc_params, geo_params = sample_params(
        jax.random.PRNGKey(0), parser.parse_args()
    )
